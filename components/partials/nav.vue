  ...
  <header class="header" :class="{'menu-open': menu, 'header--solid': (!isHome || isScrolled), 'active': true}">
    ...
    <div class="logo">
      <nuxt-link to="/" class="logo__link">
        ...
        <svg v-if="$store.state.language === 'ru'" class="logo__img logo__img--sub" width="108" height="25" viewBox="0 0 108 25" fill="none" xmlns="http://www.w3.org/2000/svg">
