...
<style scoped>
.work-activity{position:relative}.work-activity__trigger{display:flex;align-items:center;gap:8px;min-height:40px;border:1px solid #dfe4ec;border-radius: 8px;background:#fff;padding:6px 10px;color:#17233d;cursor:pointer;transition:background-color .16s ease,box-shadow .16s ease,transform .15s ease}.work-activity__trigger:hover{background:#f7f9fb;box-shadow:0 4px 12px rgba(28,41,66,.08)}.work-activity__trigger:active{transform:scale(.96)}.work-activity__orb{display:grid;place-items:center;width:28px;height:28px;border-radius:9px;background:#eef2f8}.work-activity__orb i{width:8px;height:8px;border-radius:50%;background:#47a36b}.work-activity__trigger--live .work-activity__orb{background:#eaf8ef}.work-activity__trigger--live .work-activity__orb i{animation:workPulse 1.45s ease-in-out infinite;box-shadow:0 0 0 0 rgba(71,163,107,.38)}.work-activity__label{display:grid;text-align:left}.work-activity__label strong{font-size:11px}.work-activity__label small{color:#7a879b;font-size:9px}.work-activity__panel{position:absolute;right:0;top:49px;width:min(390px,92vw);border:1px solid #e1e6ee;border-radius: 8px;background:#fff;padding:14px;box-shadow:0 18px 45px rgba(28,41,66,.16);z-index:1000}.work-panel-enter-active,.work-panel-leave-active{transition:opacity .18s ease,transform .18s ease}.work-panel-enter,.work-panel-leave-to{opacity:0;transform:translateY(-6px)}.work-activity__panel header{display:flex;justify-content:space-between;gap:10px}.work-activity__panel header div{display:grid}.work-activity__panel header span{color:#7a879b;font-size:11px}.work-activity__panel header button{display:grid;place-items:center;width:40px;height:40px;margin:-8px;border:0;background:transparent;color:#64748b;font-size:22px;cursor:pointer}.work-activity__summary{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin:13px 0}.work-activity__summary div{display:grid;border-radius: 8px;background:#f5f7fa;padding:10px}.work-activity__summary strong{font-size:19px;font-variant-numeric:tabular-nums}.work-activity__summary span{color:#7a879b;font-size:10px}.work-activity__feed{display:grid;gap:3px}.work-activity__feed article{display:grid;grid-template-columns:9px 1fr;gap:9px;align-items:start;padding:8px 4px}.work-activity__feed article div{display:grid}.work-activity__feed article strong{font-size:12px}.work-activity__feed article small,.work-activity__feed p{color:#7a879b;font-size:10px}.state{width:8px;height:8px;margin-top:3px;border-radius:50%;background:#94a3b8}.state--running,.state--queued{background:#3b82f6}.state--completed,.state--waiting_approval{background:#47a36b}.state--failed{background:#d92d20}.work-activity__panel>a{display:block;margin-top:10px;border-top:1px solid #edf0f4;padding-top:11px;color:#28456f;text-decoration:none;font-size:12px;font-weight:800}.work-activity__state{display:flex;align-items:center;gap:8px;padding:25px 8px;color:#718096;font-size:12px}.work-activity__spinner{width:16px;height:16px;border:2px solid #dce3ec;border-top-color:#28456f;border-radius:50%;animation:workSpin .8s linear infinite}.work-complete{position:fixed;right:22px;top:82px;display:flex;align-items:center;gap:10px;min-width:280px;border:1px solid #bee3cd;border-radius: 8px;background:#fff;padding:12px 14px;box-shadow:0 18px 45px rgba(28,41,66,.16)}.work-complete b{display:grid;place-items:center;width:32px;height:32px;border-radius:50%;background:#eaf8ef;color:#248253}.work-complete span{display:grid}.work-complete strong{font-size:13px}.work-complete small{color:#66748b;font-size:11px}.work-done-enter-active,.work-done-leave-active{transition:opacity .22s ease,transform .22s ease}.work-done-enter,.work-done-leave-to{opacity:0;transform:translateY(-8px) scale(.98)}@keyframes workSpin{to{transform:rotate(360deg)}}@keyframes workPulse{50%{transform:scale(1.2);box-shadow:0 0 0 7px rgba(71,163,107,0)}}@media(max-width:760px){.work-activity__label{display:none}.work-activity__trigger{padding:5px}.work-complete{left:12px;right:12px;top:72px;min-width:0}}@media(prefers-reduced-motion:reduce){.work-activity__trigger--live .work-activity__orb i,.work-activity__spinner{animation:none}.work-done-enter-active,.work-done-leave-active,.work-panel-enter-active,.work-panel-leave-active,.work-activity__trigger{transition:none}}
</style>
