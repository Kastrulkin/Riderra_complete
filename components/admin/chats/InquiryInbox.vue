<template>
  <section class="inbox" aria-label="Входящие обращения клиентов">
    <header class="inbox__head">
      <div>
        <h2>Входящие обращения</h2>
        <p>Ответьте клиенту или начните новый WhatsApp-диалог.</p>
      </div>
...
.message-media{display:grid;justify-items:start;gap:7px;margin-top:9px}.message-media img{display:block;max-width:min(100%,480px);max-height:480px;border:1px solid var(--line);border-radius: 8px;object-fit:contain;background:#fff}.message-media button,.message-media a{border:1px solid var(--line);border-radius:9px;background:#fff;color:var(--ink);padding:8px 11px;font-weight:700;text-decoration:none;cursor:pointer}.message-media span{color:#b42318;font-size:12px}
</style>
