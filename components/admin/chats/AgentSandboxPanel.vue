...
.sandbox-head{display:flex;justify-content:space-between;gap:18px}.sandbox-head h2{margin:3px 0 0;color:#17233f;font-size:24px}.sandbox-head p{margin:7px 0 0;max-width:720px;color:#64748b;line-height:1.5}.sandbox-eyebrow{color:#5d6c88;font-size:11px;font-weight:900;letter-spacing:.08em;text-transform:uppercase}.safe-badge{align-self:start;border-radius:999px;background:#ecfdf5;color:#166534;padding:7px 11px;font-size:12px;font-weight:800;white-space:nowrap}
