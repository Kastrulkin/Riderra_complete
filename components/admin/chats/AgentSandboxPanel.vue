...
<style scoped>
.sandbox-panel{display:grid;gap:16px;margin:16px 0 20px;padding:20px;border:1px solid #dce3ed;border-radius: 8px;background:#fff;box-shadow:0 12px 36px rgba(23,35,61,.06)}
...
.sandbox-setup{display:flex;align-items:end;gap:10px;padding:12px;border-radius: 8px;background:#f7f9fc}.scenario-field{display:grid;gap:5px;min-width:260px;color:#475569;font-size:12px;font-weight:800}.sandbox-advanced{margin-left:auto;color:#475569;font-size:13px}.sandbox-advanced summary{cursor:pointer;font-weight:800}.sandbox-advanced[open]{display:grid;gap:8px;min-width:280px;padding:12px;border:1px solid #dce3ed;border-radius: 8px;background:#fff}.sandbox-advanced label{display:grid;gap:5px}.sandbox-advanced small{color:#64748b}
.input{width:100%;box-sizing:border-box;border:1px solid #cfd8e6;border-radius: 8px;background:#fff;color:#17233f;padding:11px 12px}.input:focus{border-color:#49659c;outline:3px solid rgba(73,101,156,.16)}
.sandbox-loading,.sandbox-empty{display:flex;align-items:center;justify-content:center;gap:12px;min-height:180px;padding:24px;border:1px dashed #cfd8e6;border-radius: 8px;color:#64748b;text-align:center}.sandbox-loading div,.sandbox-empty{flex-direction:column}.sandbox-loading strong,.sandbox-loading span,.sandbox-empty strong,.sandbox-empty span{display:block}.sandbox-loading strong,.sandbox-empty strong{color:#17233f}.sandbox-loading div span{margin-top:4px}.spinner{width:20px;height:20px;border:2px solid #dce3ed;border-top-color:#243b73;border-radius:50%;animation:spin .8s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}
.sandbox-dialog{overflow:hidden;border:1px solid #dce3ed;border-radius: 8px;background:#f7f9fc}.sandbox-dialog__head{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:15px 17px;border-bottom:1px solid #dce3ed;background:#fff}.sandbox-dialog__head h3{margin:0;color:#17233f;font-size:17px}.sandbox-dialog__head p{margin:3px 0 0;color:#64748b;font-size:13px}.sandbox-context{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:6px}.sandbox-context span{border-radius:999px;background:#eef2f8;color:#52627b;padding:5px 8px;font-size:11px;font-weight:700}
.sandbox-messages{display:grid;gap:11px;min-height:220px;max-height:440px;overflow:auto;padding:18px}.sandbox-guide{display:grid;gap:4px;justify-self:center;max-width:520px;margin:auto;padding:18px;color:#64748b;text-align:center}.sandbox-guide strong{color:#17233f}.sandbox-message{justify-self:start;max-width:76%;border:1px solid #d8e0ee;border-radius: 8px 14px 14px 4px;background:#fff;padding:11px 13px;box-shadow:0 2px 8px rgba(23,35,61,.04)}.sandbox-message--customer{justify-self:end;border-radius: 8px 14px 4px 14px;background:#eaf1ff}.sandbox-message p{margin:5px 0 0;color:#17233f;line-height:1.45;white-space:pre-wrap;overflow-wrap:anywhere}.sandbox-message small{color:#60708f;font-weight:800}.sandbox-message--agent small{color:#36558f}.sandbox-message--thinking{color:#64748b}.thinking-dot{display:inline-block;width:5px;height:5px;margin-right:3px;border-radius:50%;background:#49659c;animation:pulse 1.1s ease-in-out infinite}.thinking-dot:nth-child(2){animation-delay:.14s}.thinking-dot:nth-child(3){animation-delay:.28s}@keyframes pulse{0%,70%,100%{opacity:.25;transform:translateY(0)}35%{opacity:1;transform:translateY(-3px)}}
...
.sandbox-error{display:flex;align-items:center;justify-content:space-between;gap:12px;border-radius: 8px;background:#fef2f2;color:#991b1b;padding:11px 13px}.sandbox-error button{border:0;background:none;color:inherit;text-decoration:underline;cursor:pointer}.btn{border:1px solid #cad5e5;border-radius: 8px;background:#fff;color:#17233f;padding:10px 14px;font-weight:800;cursor:pointer}.btn--primary{border-color:#18244a;background:#18244a;color:#fff}.btn--ghost{background:#fff}.btn:disabled{opacity:.55;cursor:not-allowed}
@media(max-width:760px){.sandbox-panel{margin-inline:-10px;padding:14px;border-radius: 8px}.sandbox-head{display:grid}.sandbox-head__actions{justify-content:flex-start}.sandbox-head__actions .btn{width:100%}.safe-badge{justify-self:start}.sandbox-setup{display:grid}.scenario-field,.sandbox-advanced[open]{min-width:0;width:100%}.sandbox-advanced{margin-left:0}.sandbox-dialog__head{align-items:flex-start;flex-direction:column}.sandbox-context{justify-content:flex-start}.sandbox-message{max-width:90%}.sandbox-compose__footer{align-items:stretch;flex-direction:column}.sandbox-compose__footer .btn{width:100%}.sandbox-error{align-items:flex-start;flex-direction:column}}
