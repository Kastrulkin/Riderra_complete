...
.staff-header__actions{position:relative;display:flex;align-items:center;gap:8px;margin-left:auto}.staff-user{display:flex;align-items:center;gap:9px;min-height:40px;border:0;border-radius:11px;background:transparent;padding:5px 7px;color:#17233d;cursor:pointer;transition:background-color .16s ease,box-shadow .16s ease,transform .15s ease}.staff-user:hover{background:#f4f6f9;box-shadow:0 4px 12px rgba(28,41,66,.08)}.staff-user:active{transform:scale(.96)}.staff-user__avatar{display:grid;place-items:center;width:34px;height:34px;border-radius:10px;background:#17233d;color:#fff;font-size:12px;font-weight:800}.staff-user__copy{display:grid;text-align:left}.staff-user__copy strong{max-width:130px;overflow:hidden;text-overflow:ellipsis;font-size:12px}.staff-user__copy small{color:#7a879b;font-size:10px}.staff-user-menu{position:absolute;right:0;top:48px;display:grid;min-width:220px;border:1px solid #e1e6ee;border-radius:12px;background:#fff;padding:8px;box-shadow:0 16px 40px rgba(28,41,66,.14)}.staff-menu-enter-active,.staff-menu-leave-active{transition:opacity .18s ease,transform .18s ease}.staff-menu-enter,.staff-menu-leave-to{opacity:0;transform:translateY(-6px)}.staff-user-menu span{padding:8px;color:#7a879b;font-size:11px;overflow-wrap:anywhere}.staff-user-menu a,.staff-user-menu button{min-height:40px;border:0;border-radius:8px;background:transparent;padding:9px 10px;color:#24324b;text-align:left;text-decoration:none;cursor:pointer;transition:background-color .16s ease}.staff-user-menu a:hover,.staff-user-menu button:hover{background:#f3f5f8}
.staff-menu-toggle,.staff-mobile-nav{display:none}
@media(max-width:1100px){.staff-menu-toggle{display:grid;gap:4px;width:40px;height:40px;place-content:center;border:1px solid #dfe4ec;border-radius:11px;background:#fff;cursor:pointer;transition:background-color .16s ease,box-shadow .16s ease,transform .15s ease}.staff-menu-toggle:hover{background:#f7f9fb;box-shadow:0 4px 12px rgba(28,41,66,.08)}.staff-menu-toggle:active{transform:scale(.96)}.staff-menu-toggle span{width:17px;height:2px;background:#1c2942}.staff-mobile-nav{display:grid;border-top:1px solid #e5e9f0;padding:10px 16px 16px;background:#fff}.staff-mobile-nav a,.staff-mobile-nav button{min-height:44px;border:0;border-radius:9px;background:transparent;padding:11px;color:#24324b;text-align:left;text-decoration:none;font-weight:700}.staff-mobile-nav a.nuxt-link-active{background:#eef2f8}.staff-user__copy{display:none}}
